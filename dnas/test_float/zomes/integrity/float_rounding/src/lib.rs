...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::AllFloatRoundingEntries => validate_create_link_all_float_rounding_entries(
                action,
                base_address,
                target_address,
                tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::AllFloatRoundingEntries => validate_delete_link_all_float_rounding_entries(
                action,
                original_action,
                base_address,
                target_address,
                ...
                match app_entry {
                    EntryTypes::FloatRoundingEntry(float_rounding_entry) => {
                        ...
                        if let ValidateCallbackResult::Valid = result {
                            let original_float_rounding_entry: Option<FloatRoundingEntry> =
                                original_record
                                    .entry()
                                    .to_app_option()
